 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var en,Fo,Gn,ar,or,Cs,Zd,Pr,ma,jd,Hi,ui,Jd,Qd=function(){return en||typeof window<"u"&&(en=window.gsap)&&en.registerPlugin&&en},ep=1,Ts=[],at=[],bi=[],_a=Date.now,Tc=function(e,t){return t},M_=function(){var e=ma.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,at),i.push.apply(i,bi),at=n,bi=i,Tc=function(a,o){return t[a](o)}},ur=function(e,t){return~bi.indexOf(e)&&bi[bi.indexOf(e)+1][t]},ga=function(e){return!!~jd.indexOf(e)},mn=function(e,t,n,i,s){return e.addEventListener(t,n,{passive:i!==!1,capture:!!s})},pn=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},Ya="scrollLeft",$a="scrollTop",bc=function(){return Hi&&Hi.isPressed||at.cache++},el=function(e,t){var n=function i(s){if(s||s===0){ep&&(Gn.history.scrollRestoration="manual");var a=Hi&&Hi.isPressed;s=i.v=Math.round(s)||(Hi&&Hi.iOS?1:0),e(s),i.cacheID=at.cache,a&&Tc("ss",s)}else(t||at.cache!==i.cacheID||Tc("ref"))&&(i.cacheID=at.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},yn={s:Ya,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:el(function(r){return arguments.length?Gn.scrollTo(r,Yt.sc()):Gn.pageXOffset||ar[Ya]||or[Ya]||Cs[Ya]||0})},Yt={s:$a,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:yn,sc:el(function(r){return arguments.length?Gn.scrollTo(yn.sc(),r):Gn.pageYOffset||ar[$a]||or[$a]||Cs[$a]||0})},bn=function(e,t){return(t&&t._ctx&&t._ctx.selector||en.utils.toArray)(e)[0]||(typeof e=="string"&&en.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},y_=function(e,t){for(var n=t.length;n--;)if(t[n]===e||t[n].contains(e))return!0;return!1},mr=function(e,t){var n=t.s,i=t.sc;ga(e)&&(e=ar.scrollingElement||or);var s=at.indexOf(e),a=i===Yt.sc?1:2;!~s&&(s=at.push(e)-1),at[s+a]||mn(e,"scroll",bc);var o=at[s+a],l=o||(at[s+a]=el(ur(e,n),!0)||(ga(e)?i:el(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,o||(l.smooth=en.getProperty(e,"scrollBehavior")==="smooth"),l},Ac=function(e,t,n){var i=e,s=e,a=_a(),o=a,l=t||50,c=Math.max(500,l*3),u=function(g,_){var m=_a();_||m-a>l?(s=i,i=g,o=a,a=m):n?i+=g:i=s+(g-s)/(m-o)*(a-o)},f=function(){s=i=n?0:i,o=a=0},h=function(g){var _=o,m=s,p=_a();return(g||g===0)&&g!==i&&u(g),a===o||p-o>c?0:(i+(n?m:-m))/((n?p:a)-_)*1e3};return{update:u,reset:f,getVelocity:h}},Zs=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},Cf=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},tp=function(){ma=en.core.globals().ScrollTrigger,ma&&ma.core&&M_()},np=function(e){return en=e||Qd(),!Fo&&en&&typeof document<"u"&&document.body&&(Gn=window,ar=document,or=ar.documentElement,Cs=ar.body,jd=[Gn,ar,or,Cs],en.utils.clamp,Jd=en.core.context||function(){},Pr="onpointerenter"in Cs?"pointer":"mouse",Zd=zt.isTouch=Gn.matchMedia&&Gn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Gn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,ui=zt.eventTypes=("ontouchstart"in or?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in or?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return ep=0},500),tp(),Fo=1),Fo};yn.op=Yt;at.cache=0;var zt=(function(){function r(t){this.init(t)}var e=r.prototype;return e.init=function(n){Fo||np(en)||console.warn("Please gsap.registerPlugin(Observer)"),ma||tp();var i=n.tolerance,s=n.dragMinimum,a=n.type,o=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,f=n.onStop,h=n.onStopDelay,d=n.ignore,g=n.wheelSpeed,_=n.event,m=n.onDragStart,p=n.onDragEnd,E=n.onDrag,T=n.onPress,x=n.onRelease,w=n.onRight,R=n.onLeft,b=n.onUp,P=n.onDown,M=n.onChangeX,S=n.onChangeY,I=n.onChange,U=n.onToggleX,k=n.onToggleY,V=n.onHover,W=n.onHoverEnd,G=n.onMove,X=n.ignoreCheck,H=n.isNormalizer,oe=n.onGestureStart,L=n.onGestureEnd,me=n.onWheel,Fe=n.onEnable,$e=n.onDisable,ke=n.onClick,He=n.scrollSpeed,Q=n.capture,te=n.allowClicks,ge=n.lockAxis,Ce=n.onLockAxis;this.target=o=bn(o)||or,this.vars=n,d&&(d=en.utils.toArray(d)),i=i||1e-9,s=s||0,g=g||1,He=He||1,a=a||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Gn.getComputedStyle(Cs).lineHeight)||22);var be,Ve,lt,C,qe,Ue,De,N=this,Ze=0,Y=0,F=n.passive||!u&&n.passive!==!1,se=mr(o,yn),ve=mr(o,Yt),A=se(),v=ve(),O=~a.indexOf("touch")&&!~a.indexOf("pointer")&&ui[0]==="pointerdown",j=ga(o),J=o.ownerDocument||ar,q=[0,0,0],he=[0,0,0],ie=0,xe=function(){return ie=_a()},ne=function(Ie,Ke){return(N.event=Ie)&&d&&y_(Ie.target,d)||Ke&&O&&Ie.pointerType!=="touch"||X&&X(Ie,Ke)},ue=function(){N._vx.reset(),N._vy.reset(),Ve.pause(),f&&f(N)},de=function(){var Ie=N.deltaX=Cf(q),Ke=N.deltaY=Cf(he),Me=Math.abs(Ie)>=i,We=Math.abs(Ke)>=i;I&&(Me||We)&&I(N,Ie,Ke,q,he),Me&&(w&&N.deltaX>0&&w(N),R&&N.deltaX<0&&R(N),M&&M(N),U&&N.deltaX<0!=Ze<0&&U(N),Ze=N.deltaX,q[0]=q[1]=q[2]=0),We&&(P&&N.deltaY>0&&P(N),b&&N.deltaY<0&&b(N),S&&S(N),k&&N.deltaY<0!=Y<0&&k(N),Y=N.deltaY,he[0]=he[1]=he[2]=0),(C||lt)&&(G&&G(N),lt&&(m&&lt===1&&m(N),E&&E(N),lt=0),C=!1),Ue&&!(Ue=!1)&&Ce&&Ce(N),qe&&(me(N),qe=!1),be=0},Le=function(Ie,Ke,Me){q[Me]+=Ie,he[Me]+=Ke,N._vx.update(Ie),N._vy.update(Ke),c?be||(be=requestAnimationFrame(de)):de()},Ae=function(Ie,Ke){ge&&!De&&(N.axis=De=Math.abs(Ie)>Math.abs(Ke)?"x":"y",Ue=!0),De!=="y"&&(q[2]+=Ie,N._vx.update(Ie,!0)),De!=="x"&&(he[2]+=Ke,N._vy.update(Ke,!0)),c?be||(be=requestAnimationFrame(de)):de()},pe=function(Ie){if(!ne(Ie,1)){Ie=Zs(Ie,u);var Ke=Ie.clientX,Me=Ie.clientY,We=Ke-N.x,Be=Me-N.y,Ye=N.isDragging;N.x=Ke,N.y=Me,(Ye||(We||Be)&&(Math.abs(N.startX-Ke)>=s||Math.abs(N.startY-Me)>=s))&&(lt=Ye?2:1,Ye||(N.isDragging=!0),Ae(We,Be))}},Ge=N.onPress=function(Se){ne(Se,1)||Se&&Se.button||(N.axis=De=null,Ve.pause(),N.isPressed=!0,Se=Zs(Se),Ze=Y=0,N.startX=N.x=Se.clientX,N.startY=N.y=Se.clientY,N._vx.reset(),N._vy.reset(),mn(H?o:J,ui[1],pe,F,!0),N.deltaX=N.deltaY=0,T&&T(N))},D=N.onRelease=function(Se){if(!ne(Se,1)){pn(H?o:J,ui[1],pe,!0);var Ie=!isNaN(N.y-N.startY),Ke=N.isDragging,Me=Ke&&(Math.abs(N.x-N.startX)>3||Math.abs(N.y-N.startY)>3),We=Zs(Se);!Me&&Ie&&(N._vx.reset(),N._vy.reset(),u&&te&&en.delayedCall(.08,function(){if(_a()-ie>300&&!Se.defaultPrevented){if(Se.target.click)Se.target.click();else if(J.createEvent){var Be=J.createEvent("MouseEvents");Be.initMouseEvent("click",!0,!0,Gn,1,We.screenX,We.screenY,We.clientX,We.clientY,!1,!1,!1,!1,0,null),Se.target.dispatchEvent(Be)}}})),N.isDragging=N.isGesturing=N.isPressed=!1,f&&Ke&&!H&&Ve.restart(!0),lt&&de(),p&&Ke&&p(N),x&&x(N,Me)}},le=function(Ie){return Ie.touches&&Ie.touches.length>1&&(N.isGesturing=!0)&&oe(Ie,N.isDragging)},ce=function(){return(N.isGesturing=!1)||L(N)},fe=function(Ie){if(!ne(Ie)){var Ke=se(),Me=ve();Le((Ke-A)*He,(Me-v)*He,1),A=Ke,v=Me,f&&Ve.restart(!0)}},re=function(Ie){if(!ne(Ie)){Ie=Zs(Ie,u),me&&(qe=!0);var Ke=(Ie.deltaMode===1?l:Ie.deltaMode===2?Gn.innerHeight:1)*g;Le(Ie.deltaX*Ke,Ie.deltaY*Ke,0),f&&!H&&Ve.restart(!0)}},ee=function(Ie){if(!ne(Ie)){var Ke=Ie.clientX,Me=Ie.clientY,We=Ke-N.x,Be=Me-N.y;N.x=Ke,N.y=Me,C=!0,f&&Ve.restart(!0),(We||Be)&&Ae(We,Be)}},Ee=function(Ie){N.event=Ie,V(N)},Pe=function(Ie){N.event=Ie,W(N)},rt=function(Ie){return ne(Ie)||Zs(Ie,u)&&ke(N)};Ve=N._dc=en.delayedCall(h||.25,ue).pause(),N.deltaX=N.deltaY=0,N._vx=Ac(0,50,!0),N._vy=Ac(0,50,!0),N.scrollX=se,N.scrollY=ve,N.isDragging=N.isGesturing=N.isPressed=!1,Jd(this),N.enable=function(Se){return N.isEnabled||(mn(j?J:o,"scroll",bc),a.indexOf("scroll")>=0&&mn(j?J:o,"scroll",fe,F,Q),a.indexOf("wheel")>=0&&mn(o,"wheel",re,F,Q),(a.indexOf("touch")>=0&&Zd||a.indexOf("pointer")>=0)&&(mn(o,ui[0],Ge,F,Q),mn(J,ui[2],D),mn(J,ui[3],D),te&&mn(o,"click",xe,!0,!0),ke&&mn(o,"click",rt),oe&&mn(J,"gesturestart",le),L&&mn(J,"gestureend",ce),V&&mn(o,Pr+"enter",Ee),W&&mn(o,Pr+"leave",Pe),G&&mn(o,Pr+"move",ee)),N.isEnabled=!0,N.isDragging=N.isGesturing=N.isPressed=C=lt=!1,N._vx.reset(),N._vy.reset(),A=se(),v=ve(),Se&&Se.type&&Ge(Se),Fe&&Fe(N)),N},N.disable=function(){N.isEnabled&&(Ts.filter(function(Se){return Se!==N&&ga(Se.target)}).length||pn(j?J:o,"scroll",bc),N.isPressed&&(N._vx.reset(),N._vy.reset(),pn(H?o:J,ui[1],pe,!0)),pn(j?J:o,"scroll",fe,Q),pn(o,"wheel",re,Q),pn(o,ui[0],Ge,Q),pn(J,ui[2],D),pn(J,ui[3],D),pn(o,"click",xe,!0),pn(o,"click",rt),pn(J,"gesturestart",le),pn(J,"gestureend",ce),pn(o,Pr+"enter",Ee),pn(o,Pr+"leave",Pe),pn(o,Pr+"move",ee),N.isEnabled=N.isPressed=N.isDragging=!1,$e&&$e(N))},N.kill=N.revert=function(){N.disable();var Se=Ts.indexOf(N);Se>=0&&Ts.splice(Se,1),Hi===N&&(Hi=0)},Ts.push(N),H&&ga(o)&&(Hi=N),N.enable(_)},S_(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r})();zt.version="3.13.0";zt.create=function(r){return new zt(r)};zt.register=np;zt.getAll=function(){return Ts.slice()};zt.getById=function(r){return Ts.filter(function(e){return e.vars.id===r})[0]};Qd()&&en.registerPlugin(zt);/*!
...
void main() {
  ...
  `}function KM(){ff("home"),an.registerPlugin(nt);function r(l){document.querySelectorAll(l).forEach(c=>{const f=c.innerText.split("");c.innerHTML=f.map(h=>`<span>${h===" "?"&nbsp;":h}</span>`).join("")})}r(".intro__firstname"),r(".intro__lastname"),r(".intro__subtitle");const e=an.timeline({delay:.3,paused:!0}),t=document.querySelectorAll(".intro__firstname span"),n=document.querySelectorAll(".intro__lastname span"),i=document.querySelectorAll(".intro__subtitle span"),s=document.querySelectorAll(".intro__text"),a=document.querySelectorAll(".go-scroll");e.to(".intro__photo",{scale:1,rotation:4,duration:1.2,ease:"power3.out"}),e.to(t,{y:0,stagger:.05,duration:.6,ease:"power3.out"},"-=1"),e.to(n,{y:0,stagger:.05,duration:.6,ease:"power3.out"},"-=0.9"),e.to(i,{opacity:1,y:0,stagger:.03,duration:.8,ease:"power2.out"},"-=0.4"),e.to(s,{opacity:1,y:0,stagger:.03,duration:.8,ease:"power2.out"},"-=0.4"),e.to(a,{opacity:1,y:0,stagger:.03,duration:.8,ease:"power2.out"},"-=0.4"),setTimeout(()=>e.play(),300),em=an.context(()=>{Jp(".hero-title"),r(".process-step h2 span, .process-step h3 span");const l=document.querySelector(".process-inner"),c=an.utils.toArray(".process-step"),u=an.timeline({scrollTrigger:{trigger:l,start:"top top",end:"+="+window.innerHeight*c.length*c.length,scrub:!0,pin:!0}}),f=1.5;c.forEach((h,d)=>{const g=h.querySelectorAll("h2 span span, h3 span span"),_=h.querySelector("p span"),m=h.querySelector("img");an.set(h,{autoAlpha:0}),an.set(g,{yPercent:100,opacity:0}),an.set(_,{yPercent:100,opacity:0}),an.set(m,{xPercent:100}),u.to(h,{autoAlpha:1,duration:.1}).to(g,{yPercent:0,opacity:1,stagger:.005,duration:.25*f,ease:"power3.out"},"<").to(_,{yPercent:0,opacity:1,duration:.25*f,ease:"power3.out"},"<0.1").to(m,{xPercent:0,duration:.3*f,ease:"power3.out"},"<0.2").to(g,{yPercent:-100,opacity:0,stagger:.005,duration:.2*f,ease:"power3.in"},"+=0.2").to(_,{yPercent:-100,opacity:0,duration:.2*f,ease:"power3.in"},"<").to(m,{xPercent:-100,duration:.3*f,ease:"power3.inOut"},"<").to(h,{autoAlpha:0,duration:.1})}),setTimeout(()=>nt.refresh(),200)});const o=document.querySelector("#three-container");Eu=new Qp(o,l=>{const c=new Xa(6,3,40,20),u=new Xp({color:65484,wireframe:!0,side:Si});Ro=new di(c,u),l.add(Ro)}),Eu.start(()=>{lc+=.02;const l=Ro.geometry.attributes.position,c=l.count;for(let u=0;u<c;u++){const f=l.getX(u),h=l.getY(u),d=Math.sin(f*1.5+lc)*.125+Math.cos(h*1.2+lc*.7)*.25;l.setZ(u,d)}l.needsUpdate=!0,Ro.geometry.computeVertexNormals()})}function ZM(){em?.revert(),Eu?.dispose()}let tm;function jM(){return`
    <section class="works">
